...
add_links({baske_data: dockerContainer_payment_data}, role_name="to", stereotype_instances=[deployed_on_deployment_node_relation_type])
...
add_links({catalog_data: dockerContainer_payment_data}, role_name="to", stereotype_instances=[deployed_on_deployment_node_relation_type])
...
add_links({basket_service: dockerContainer_payment}, role_name="deployment_nodes", stereotype_instances=[deployed_on_type])
...
add_links({catalog_service: dockerContainer_payment}, role_name="deployment_nodes", stereotype_instances=[deployed_on_type])
...
'''
_all = CBundle("S1V2", elements = elkServer.class_object.get_connected_elements())
S1V2Views = [_all, {},]
