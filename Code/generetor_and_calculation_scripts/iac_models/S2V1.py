...
stack_3 = CClass(infrastructure_resources, 'Stack 3', stereotype_instances=[infrastructure_stack_type])
...
add_links({stack_3 : [test_env, production_env, staging_env]}, role_name="to", stereotype_instances=[includes_deployment_node_relation_type])
...
#Views
_all = CBundle("S2V1", elements = awsServer.class_object.get_connected_elements())
