...
infrastructure_resources = CMetaclass("Infrastructure Resources", superclasses=deployment_node)
execution_environment = CMetaclass("Execution Environment", superclasses=deployment_node)

#
# deployment component types
#
infrastructure_resources_type = CStereotype("Infrastructure Resources Type", extended=infrastructure_resources)
infrastructure_stack_type = CStereotype("Infrastructure Stack", superclasses=infrastructure_resources_type)
web_server_infrastructure_type = CStereotype("Web Server", superclasses=infrastructure_resources_type)
storage_resources_infrastructure_type = CStereotype("Storage Resources", superclasses=infrastructure_resources_type)
network_resources_infrastructure_type = CStereotype("Network Resources", superclasses=infrastructure_resources_type)
compute_resources_infrastructure_type = CStereotype("Compute Resources", superclasses=infrastructure_resources_type)
#
# device types
#
...
#
# devops specific kinds of environments
#

test_env_type = CStereotype("Test Environment", superclasses = execution_environment_type)
production_env_type = CStereotype("Production Environment", superclasses = execution_environment_type)
staging_env_type = CStereotype("Staging Environment", superclasses = execution_environment_type)
...
defines_deployment_of_deployment_node_relation_type = CStereotype("defines deployment of", superclasses=deployment_relation_type)
runs_on_deployment_relation_type = CStereotype("runs on", superclasses=deployment_relation_type)
contained_in_deployment_relation_type = CStereotype("contained in", superclasses=deployment_relation_type)
...
deployed_on_deployment_node_relation_type = CStereotype("deployed on", superclasses=deployment_node_relation_type)
...
defines_deployment_of_deployment_node_relation_type = CStereotype("defines deployment of", superclasses=deployment_node_relation_type)
includes_deployment_node_relation_type = CStereotype("includes", superclasses=deployment_node_relation_type)
