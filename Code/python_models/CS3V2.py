...
add_links({paypalPaymentGateway: dockerContainer_api}, role_name="deployment_nodes", stereotype_instances=[deployed_on_type])
...
#Views
_all = CBundle("S3V2", elements = awsServer.class_object.get_connected_elements())


robotShopViewsV2 = [_all,{}, 
            #terraform, {}
            ]
