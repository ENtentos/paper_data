...
#stacks
stack = CClass(infrastructure_resources, 'Application Stack', stereotype_instances=[infrastructure_stack_type])
...
add_links({stack : [test_env, production_env, staging_env]}, role_name="to", stereotype_instances=[includes_deployment_node_relation_type])
...
add_links({catalog: dockerContainer_catalog}, role_name="deployment_nodes", stereotype_instances=[deployed_on_type])
...
add_links({shippingService: dockerContainer_shipping}, role_name="deployment_nodes", stereotype_instances=[deployed_on_type])
...
add_links({userDB: user_mongo}, role_name="deployment_nodes", stereotype_instances=[deployed_on_type])
...
#Views
_all = CBundle("S2", elements=[awsServer, webserver0_0_0_0, elasticsearch, kibana, user, catalog, order,shippingService,payment, cart, userDB, cartDB, orderDB,catalogDB, apiGateway, browser, stack, test_env, production_env, staging_env,dockerContainer_shipping,
dockerContainer_catalog,
dockerContainer_order,
dockerContainer_payment,
dockerContainer_user,
...
dockerContainer_userDB,
dockerContainer_catalogDB,
dockerContainer_edge_router,browser, qmaster, broker, user_mongo, mongo, catalog_mysql ])

terraform = CBundle("IaC Deployment", elements=[awsServer, webserver0_0_0_0, elasticsearch, kibana, stack, test_env, production_env, staging_env, dockerContainer_shipping,
dockerContainer_catalog,
dockerContainer_order,
dockerContainer_payment,
dockerContainer_user,
...
dockerContainer_userDB,
dockerContainer_catalogDB,
dockerContainer_edge_router, user_mongo, mongo, catalog_mysql ])
